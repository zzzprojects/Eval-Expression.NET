...
namespace Z.Expressions
{
    ...
    {
        public static object Execute(this IQueryable source, string expression)
        {
            return source.Execute<object>(expression, null);
        }

        public static object Execute(this IQueryable source, string expression, object parameter)
        {
            return source.Execute<object>(expression, null);
        }

        public static TValue Execute<TValue>(this IQueryable source, string expression)
        {
