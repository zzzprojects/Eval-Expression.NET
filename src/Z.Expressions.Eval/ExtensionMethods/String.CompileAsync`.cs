...
namespace Z.Expressions
{
    public static partial class Extensions
    {
        ...
        public static Task<TDelegate> CompileAsync<TDelegate>(this string code)
        {
        ...
        /// <returns>A TDelegate of type Func or Action that represents the compiled code or expression.</returns>
        public static Task<TDelegate> CompileAsync<TDelegate>(this string code, IEnumerable<string> parameterNames)
        {
        ...
        /// <param name="parameterNames">Parameter names used to compile the code or expressions.</param>
        /// <returns>A TDelegate of type Func or Action that represents the compiled code or expression.</returns>
        public static Task<TDelegate> CompileAsync<TDelegate>(this string code, params string[] parameterNames)
        {
            return EvalManager.DefaultContext.CompileAsync<TDelegate>(code, parameterNames);
        }
    }
