...
> Improve dramatically C# reflection performance by using Eval Expression.NET. Access to public and private property value or to create instance with an easy to use API.
